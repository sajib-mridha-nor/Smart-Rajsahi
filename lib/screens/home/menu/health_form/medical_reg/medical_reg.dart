...
class MedicalRegFormPage extends StatefulWidget {
  const MedicalRegFormPage({Key? key}) : super(key: key);

  @override
  State<MedicalRegFormPage> createState() => _MedicalRegFormPageState();
}

class _MedicalRegFormPageState extends State<MedicalRegFormPage> {
