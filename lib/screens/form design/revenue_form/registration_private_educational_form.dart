...
class RegistrationPrivateEducationalForm extends StatefulWidget {
  ...
  @override
  State<RegistrationPrivateEducationalForm> createState() => _RegistrationPrivateEducationalFormState();
}

class _RegistrationPrivateEducationalFormState extends State<RegistrationPrivateEducationalForm> {
  final _items = [
    "1",
    "2",
    "3",
      ...
      body: SingleChildScrollView(
        ...
        const SizedBox(
          height: 8,
              ...
              Row(
                children: [
                  Expanded(
                    ...
                    child:
                    CustomTextField(
                        label: 'শিক্ষাপ্রতিষ্ঠানের নাম', hint: '', onChange: () {}),
                  ),
                  const SizedBox(
                    width: 8.0,
                  ),
                  Expanded(
                    ...
                    child:  CustomTextField(
                        label: 'প্রতিষ্ঠান স্থান (এলাকার নাম)', hint: '', onChange: () {}),
                  ),
                ],
              ),
              const SizedBox(
              ...
              CustomTextField(
                  label: 'শিক্ষাপ্রতিষ্ঠানের ঠিকানা (বিস্তারিত লিখুন)', hint: '', onChange: () {}),
              const SizedBox(
                height: 8.0,
              ),
              Row(
