...
class ApplicationShopTransferFormPage extends StatefulWidget {
  const ApplicationShopTransferFormPage({Key? key}) : super(key: key);

  @override
  State<ApplicationShopTransferFormPage> createState() =>
      _ApplicationShopTransferFormPageState();
}

class _ApplicationShopTransferFormPageState
    extends State<ApplicationShopTransferFormPage> {
  final _items = [
    "1",
    "2",
    "3",
